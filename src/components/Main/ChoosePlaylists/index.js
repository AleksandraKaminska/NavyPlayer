...
export default class ChoosePlaylists extends Component {
    playlists = [
        1629925235, 1479458365, 1925105902, 1934257882,
        1911222042, 2272152422, 1320283135,
        1910344822, 801618141, 1358731495,
        733113466, 2113355604, 1266972311,
    ...
    render() {
        return (
            <section id="playlists" className="playlists" onMouseEnter={this.toggleOpacity} onMouseLeave={this.toggleOpacity}>
                <div>
